...
from tensorflow.keras.layers import SimpleRNN, Bidirectional, Embedding, Dense, GlobalMaxPool1D, BatchNormalization
...
save_weight_path = "weights/v2/best_model.weights"
save_model_path = "weights/v2/fashion_mnist_model.h5"
...
df = pd.read_csv(data_path, header=0, encoding='gbk')
df = df.sample(frac=1)
...
output = Bidirectional(
    SimpleRNN(128, return_state=False, return_sequences=False)
)(output)
