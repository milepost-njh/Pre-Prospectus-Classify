...
# 一,特征工程,处理数据
# [csv数据文本地址]
# csv_file_path = "./my_csv_label.csv"
csv_file_path = "./v3_my_csv_label_arg_number.csv"
# [词典路径]
...
df_data.rename(columns={0:'title_name',1:'label'},inplace=True) 
...
if os.path.exists(word_dict_path):
    ...
    title_list = df_data["title_name"].tolist()
